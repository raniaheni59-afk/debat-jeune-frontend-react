...
const Notifications = () => {
  ...
  const handleClick = async (n) => {
    ...
    // Naviguer vers la publication si entity_id existe
    // (vérifier entity_type OU type_notification comme fallback)
    const isPubNotif =
      n.entity_id && (
        ...
        <div style={{ display:"flex", alignItems:"center", marginBottom:24, gap:12 }}>
          ...
          <div style={{ flex:1 }}>
            <h1 style={{ margin:0, fontSize:22, fontWeight:700, color:"#1a1a2e" }}>
              ...
              {unreadCount > 0 && (
                <span style={{
                  background:"#667eea", color:"white", borderRadius:20,
                  padding:"2px 10px", fontSize:13, marginLeft:10, fontWeight:600,
                }}>
                  {unreadCount}
                </span>
              )}
          ...
          {unreadCount > 0 && (
            <button
              ...
              style={{
                ...
                color:"#667eea", cursor:"pointer", fontSize:13, fontWeight:500,
              }}
            >
              Tout lire
            </button>
