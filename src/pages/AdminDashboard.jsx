...
export default function AdminDashboard() {
  ...
  const [activePage, setActivePage]     = useState(() => {
    const saved = localStorage.getItem("admin_activePage");
    const valid = ["accueil","dashboard","messages","publier","calendrier","swafyMeet","enquetes","participant","suivi","notification","archive","newlive","live","parametre","parametreContact"];
  ...
  const logout = () => {
    ...
    setTimeout(() => {
      ...
      localStorage.removeItem("admin_activePage");
      navigate("/");
    }, 800);
  };
