...
.sw-partners-left {
  font-size: 0.68rem; color: rgba(255,255,255,0.5); font-style: italic;
}
.sw-partners-logos {
...
.sw-partner-logo:hover { opacity: 1; }
.sw-partner-sep { width: 1px; height: 24px; background: rgba(255,255,255,0.2); }
.sw-partner-text {
  font-size: 0.65rem; color: rgba(255,255,255,0.55);
  max-width: 80px; line-height: 1.3; font-weight: 500;
}
.sw-eu4y {
  font-family: "Clash Display", sans-serif; font-weight: 800;
  font-size: 0.9rem; color: rgba(255,255,255,0.85); line-height: 1.1;
}
...
.sw-footer-partners-title {
  font-size: 0.68rem; font-weight: 600; text-transform: uppercase;
  letter-spacing: 0.12em; color: rgba(255,255,255,0.4); margin-bottom: 16px;
}
.sw-footer-logos {
...
.sw-footer-logos img:hover { opacity: 0.9; }
.sw-eu-badge {
...
function SwPartnersBar() {
  return (
    <div className="sw-partners-bar">
      <div className="sw-partners-inner">
        <span className="sw-partners-left">logo Association</span>
        <div className="sw-partners-logos">
          <img src="/logo_150-04__1_.png" alt="SWAFY" className="sw-partner-logo" />
          <div className="sw-partner-sep" />
          <span className="sw-partner-text">Agence Nationale de la Promotion de la Recherche scientifique</span>
          <div className="sw-partner-sep" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Flag_of_Europe.svg/40px-Flag_of_Europe.svg.png"
               alt="EU" style={{height:22, filter:"none", opacity:1}} />
          <span className="sw-partner-text">Délégation de l'Union européenne en Tunisie</span>
          <div className="sw-partner-sep" />
          <span className="sw-eu4y">≡EU<br/><span style={{fontSize:"0.7rem",fontWeight:600}}>4Youth</span></span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="sw-modal-overlay" onClick={onClose}>
      <div className="sw-modal" onClick={e => e.stopPropagation()}>
        ...
        {isYoutube ? (
          <iframe src={videoUrl + "?autoplay=1"} title="SWAFY video"
            allow="autoplay; encrypted-media" allowFullScreen />
        ) : (
          <video src={videoUrl} controls autoPlay
            style={{ width:"100%", display:"block", borderRadius:12, maxHeight:"75vh", background:"#000" }}>
      ...
      <div className="sw-container">
        ...
        <div className="sw-team-grid">
          {team.map((m) => (
            ...
            >
              {m.img && !m.img.includes('/team/') ? (
                <img className="sw-member-img" src={m.img} alt={m.name}
                   style={{ borderColor: `${m.color}80` }} />
              ) : (
                <div className="sw-member-img sw-member-initials"
                  style={{ background: `linear-gradient(135deg, ${m.color}40, ${m.color}20)`,
                           borderColor: `${m.color}80`, display:"flex", alignItems:"center",
...
function VideosSection({ videos, onPlay }) {
  return (
    <section className="sw-section-alt">
      <div className="sw-container">
        <div className="sw-section-eyebrow">
          <div className="sw-eyebrow-line" /> Nos vidéos
        </div>
        <h2 className="sw-section-title">Revivez nos moments forts</h2>
        <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:18, marginTop:40 }}>
          {videos.map((v) => (
            <div key={v.file} onClick={() => onPlay(v.file)}
              style={{ borderRadius:20, overflow:"hidden", cursor:"pointer",
                border:"1px solid rgba(255,255,255,0.12)", background:"rgba(255,255,255,0.06)",
                transition:"all 0.28s ease" }}
              onMouseEnter={e => { e.currentTarget.style.transform="translateY(-4px)"; e.currentTarget.style.boxShadow="0 20px 60px rgba(50,30,100,0.45)"; }}
              onMouseLeave={e => { e.currentTarget.style.transform=""; e.currentTarget.style.boxShadow=""; }}
            >
              <div style={{ position:"relative", overflow:"hidden", aspectRatio:"16/9" }}>
                <img src={v.thumb} alt={v.title}
                  style={{ width:"100%", height:"100%", objectFit:"cover", display:"block" }} />
                <div style={{ position:"absolute", inset:0, background:"rgba(50,30,100,0.5)",
                  display:"flex", alignItems:"center", justifyContent:"center" }}>
                  <div style={{ width:52, height:52, background:"rgba(255,255,255,0.92)",
                    borderRadius:"50%", display:"flex", alignItems:"center", justifyContent:"center",
                    fontSize:20, color:"var(--bg-deep)", boxShadow:"0 8px 28px rgba(0,0,0,0.4)" }}>
                    <FiPlay />
                  </div>
                </div>
              </div>
              <div style={{ padding:"14px 14px 16px" }}>
                <span style={{ display:"inline-block", fontSize:"0.68rem", fontWeight:700,
                  color:"var(--accent)", background:"rgba(200,184,255,0.12)",
                  borderRadius:20, padding:"2px 8px", marginBottom:7, textTransform:"uppercase" }}>
                  {v.duration}
                </span>
                <div style={{ fontSize:"0.9rem", fontWeight:600, color:"#fff", lineHeight:1.35 }}>
                  {v.title}
                </div>
              </div>
            </div>
...
export default function Swafy() {
  ...
  const team = useMemo(() => [
    { name: "Prof. Chedly Abdelli",   role: "Directeur Général · ANPR",          img: "/team/chedly-abdelli.jpg",   color: "#9b5de5", initials: "CA" },
    { name: "Dhouha Sbaoulji",        role: "Cheffe de Projet SWAFY",            img: "/team/dhouha-sbaoulji.jpg",  color: "#7260A7", initials: "DS" },
    { name: "Bouchra Belhaj Abdallah",role: "Experte Scientifique & Terrain",    img: "/team/bouchra-belhaj.jpg",   color: "#00bbf9", initials: "BB" },
    { name: "Équipe ANPR",            role: "Coordination & Suivi de Projet",    img: "/team/team-anpr.jpg",        color: "#f15bb5", initials: "AN" },
    { name: "Délégation UE Tunisie",  role: "Partenaire Financeur · EU4Youth",   img: "/team/eu-delegation.jpg",    color: "#0066cc", initials: "EU" },
    { name: "Experts Associatifs",    role: "Clubs Scientifiques · 19 Gouvernorats", img: "/team/experts.jpg",     color: "#fb8500", initials: "EA" },
  ], []);

  const gallery = useMemo(() => [
    "/gallery/0F9A0469.JPG", "/gallery/0F9A0486.JPG", "/gallery/0F9A0516.JPG",
    "/gallery/0F9A0553.JPG", "/gallery/0F9A0623.JPG", "/gallery/0F9A0628.JPG",
    "/gallery/0F9A0648.JPG", "/gallery/0F9A0678.JPG", "/gallery/0F9A1047.JPG",
    "/gallery/7N7A4220.JPG", "/gallery/7N7A4258.JPG", "/gallery/7N7A4261.JPG",
    "/gallery/7N7A4268.JPG", "/gallery/7N7A4272.JPG", "/gallery/7N7A4290.JPG",
    "/gallery/7N7A4508.JPG", "/gallery/7N7A4764.JPG", "/gallery/7N7A4814.JPG",
    "/gallery/7N7A4815.JPG", "/gallery/7N7A4835.JPG", "/gallery/7N7A4837.JPG",
    "/gallery/7N7A4838.JPG", "/gallery/7N7A4840.JPG", "/gallery/7N7A4901.JPG",
    "/gallery/7N7A4903.JPG", "/gallery/7N7A4906.JPG", "/gallery/7N7A5143.JPG",
    "/gallery/7N7A5247.JPG", "/gallery/421A6130.JPG", "/gallery/421A7814.JPG",
    "/gallery/421A8007.JPG", "/gallery/421A8021.JPG", "/gallery/421A8093.JPG",
    "/gallery/421A8094.JPG", "/gallery/421A8398.JPG", "/gallery/421A8410.JPG",
    "/gallery/421A9023.JPG", "/gallery/421A9027.JPG", "/gallery/421A9036.JPG",
    "/gallery/421A9047.JPG", "/gallery/DSC_1878.JPG", "/gallery/DSC_2059.JPG",
    "/gallery/DSC_2243.JPG", "/gallery/DSC_2271.JPG", "/gallery/DSC_2278.JPG",
    "/gallery/DSC_2281.JPG", "/gallery/DSC_2285.JPG", "/gallery/DSC_2427.JPG",
    "/gallery/DSC_2429.JPG", "/gallery/DSC_2538.JPG", "/gallery/DSC_2863.JPG",
    "/gallery/DSC_2979.JPG", "/gallery/DSC_3205.JPG", "/gallery/DSC_3249.JPG",
    "/gallery/DSC_3256.JPG", "/gallery/DSC_3351.JPG", "/gallery/DSC_3363.JPG",
    "/gallery/DSC_3426.JPG", "/gallery/DSC_3446.JPG", "/gallery/WKH_3936.JPG",
    "/gallery/WKH_4323.JPG", "/gallery/WKH_4336.JPG", "/gallery/WKH_4441.JPG",
    "/gallery/WKH_4645.JPG", "/gallery/WKH_4875.JPG", "/gallery/WKH_4877.JPG",
    "/gallery/WKH_4888.JPG",
  ], []);

  const videos = useMemo(() => [
    { title: "Récap Robot Battle",  file: "/videos/recap-robot-battle.mp4",  thumb: "/gallery/DSC_2281.JPG", duration: "3 min" },
    { title: "RF Résumé 19-02-25",  file: "/videos/RF-Resume-19-02-25.mp4",  thumb: "/gallery/7N7A4814.JPG", duration: "Résumé" },
    { title: "SWAFY Launching",     file: "/videos/SWAFY-launching.mp4",     thumb: "/gallery/0F9A0486.JPG", duration: "Lancement" },
    { title: "Swafy VF",            file: "/videos/swafy-VF.mp4",            thumb: "/gallery/WKH_4875.JPG", duration: "VF" },
  ], []);
  ...
  return (
    <>
      ...
      <div className="sw-page">
        ...
        <VideosSection videos={videos} onPlay={(v) => { setActiveVideo(v); setOpenVideo(true); }} />
        <WhySection why={why} />
        ...
        <footer className="sw-footer">
          <div className="sw-container">
            ...
            {/* Partner logos */}
            <div className="sw-footer-partners">
              <div className="sw-footer-partners-title">Partenaires & Financeurs</div>
              <div className="sw-footer-logos">
                <div className="sw-eu-badge">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Flag_of_Europe.svg/30px-Flag_of_Europe.svg.png"
                       alt="EU" style={{height:18, filter:"none"}} />
                  Projet financé par l'Union européenne
                </div>
                <img src="/logo_150-04__1_.png" alt="SWAFY" style={{height:36}} />
                <span style={{fontFamily:"Clash Display,sans-serif",fontWeight:800,fontSize:"1rem",color:"rgba(255,255,255,0.7)"}}>ANPR</span>
                <span style={{fontFamily:"Clash Display,sans-serif",fontWeight:800,fontSize:"0.9rem",color:"rgba(255,255,255,0.7)"}}>EU4Youth</span>
              </div>
            </div>
          </div>
        </footer>
      ...
      <VideoModal
        ...
        videoUrl={activeVideo || "/videos/SWAFY-launching.mp4"}
      />
    </>
  );
}